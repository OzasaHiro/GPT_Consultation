    ...
    render() {
        ...
        return (
            ...
            <GridItem className="primary-content-container" columnSpan={6}>
                ...
                <TableChart fullWidth accountId={this.accountId} query={avgResTime} />
                </main>
            </GridItem>
            ...
            <GridItem className="primary-content-container" columnSpan={6}>
                ...
                <iframe src="https://ozasahiro-gpt-consultation-chat-app-x42yr3.streamlit.app/?embedded=true" width="650" height="300" />
                </main>
            </GridItem>
